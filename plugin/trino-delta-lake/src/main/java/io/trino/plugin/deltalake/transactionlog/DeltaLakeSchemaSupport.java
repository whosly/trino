...
public final class DeltaLakeSchemaSupport
{
    ...
    public static ParquetColumnMapping getParquetColumnMapping(MetadataEntry metadata)
    {
        ColumnMappingMode columnMappingMode = getColumnMappingMode(metadata);
        switch (columnMappingMode) {
            case ID:
                return ParquetColumnMapping.FIELD_ID;
            case NAME:
            case NONE:
