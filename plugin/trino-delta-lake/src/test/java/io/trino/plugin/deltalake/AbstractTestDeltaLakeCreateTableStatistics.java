        ...
        extends AbstractTestQueryFramework
{
    ...
    public void testMultiFileTable()
            throws Exception
    {
        DeltaLakeColumnHandle columnHandle = new DeltaLakeColumnHandle("name", createUnboundedVarcharType(), OptionalInt.empty(), "name", createUnboundedVarcharType(), REGULAR);
